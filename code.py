...
class RPiSenseHat(Tk.Frame):
	...
	def startGUI(self):
		...
		self.button1 = Tk.Button(self.frame, bg = 'white', text="Temperatura", height = 2, width = 20,
			command = lambda: self.senseTemperature(), font=helv12)
		self.button1.pack()
		
		# Button : Humidity Sensor
		self.button2 = Tk.Button(self.frame, bg = 'white', text="Humedad", height = 2, width = 20, 
			command = lambda: self.senseHumidity(), font=helv12)
		self.button2.pack()
		
		# Button : Pressure Sensor
		self.button3 = Tk.Button(self.frame, bg = 'white', text="Presion", height = 2, width = 20,
			command = lambda: self.sensePressure(), font=helv12)
		self.button3.pack()
		
		# Button : Gyroscope
		self.button4 = Tk.Button(self.frame, bg = 'white', text="Giroscopio", height = 2, width = 20,
			command = lambda: self.senseGyro(), font=helv12)
		self.button4.pack()
		
		# Button : Accelerometer
		self.button5 = Tk.Button(self.frame, bg = 'white', text="Acelerometro", height = 2, width = 20,
			command = lambda: self.senseAcc(), font=helv12)
		self.button5.pack()
		
		# Button : Magnetometer
		self.button6 = Tk.Button(self.frame, bg = 'white', text="Magnetommetro", height = 2, width = 20,
			command = lambda: self.senseMagF(), font=helv12)
		self.button6.pack()		
		
		# Button : LED Matrix
		self.button7 = Tk.Button(self.frame, bg = 'white', text="Matriz de Led", height = 2, width = 20,
	...
	def senseTemperature(self):
		...
		self.button1["bg"] = 'magenta'
		self.button1["text"] = 'Temperatura \n' + str("%.3f" %temp) + ' deg. C'
				
	def senseHumidity(self):
		""" Senses Current Humidity """
		print "Sensing Humidity"
		humid = sense.get_humidity()
		self.button2["bg"] = 'magenta'
		self.button2["text"] = 'Humedad \n' + str("%.3f" %humid) + ' %'
		
	def sensePressure(self):
		""" Senses Current Pressure """
		print "Sensing Pressure"
		press = sense.get_pressure()
		self.button3["bg"] = 'magenta'
		self.button3["text"] = 'Presion \n' + str("%.3f" %press) + ' mBar'
	...
	def senseGyro(self):
		...
		# Start button
		self.buttonStart = Tk.Button(self.frame, bg = 'white', text="iniciar", height = 1, width = 15,
			command = lambda: self.mGyro(1), font=helv12).grid(row=0,column=0)
		
		# Stop button
		self.buttonStop = Tk.Button(self.frame, bg = 'white', text="parar", height = 1, width = 15,
